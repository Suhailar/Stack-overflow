...
const AskQuestion = () => {
    const [ questionTitle, setQuestionTitle ] = useState('') // get the data
            ...
            <div className='ask-ques-container'>
                ...
                <form onSubmit={handleSubmit}>
                    <div className='ask-form-container'>
                        ...
                        <label htmlFor="asl-ques-tags">
                            <h4>Tags</h4>
                            <p>Add up to 5 tags to describe what your question is about. Start typing to see suggestions..</p>
                            <input type="text" id='ask-ques-tags' onChange={(e) => {setQuestionTags(e.target.value.split(' '))}} placeholder='e.g. (xml objective-c javascript)'/>
                        </label>
                    </div>
